            ...
            <div className="w-full md:w-1/2 bg-white shadow-lg rounded-lg p-5">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="my-3">
                        ...
                        <input type="password" name="pwd_actual" className="border bg-gray-50 w-full p-2 mt-5 rounded-lg" placeholder="Escribe tu password actual" onChange={e => setPassword({
                            ...password,
                    ...
                    <div className="my-3">
                        ...
                        <input type="password" name="pwd_nuevo" className="border bg-gray-50 w-full p-2 mt-5 rounded-lg" placeholder="Escribe tu nuevo password" onChange={e => setPassword({
                            ...password,
                            [e.target.name]: e.target.value
                        })}/>
                    </div>
